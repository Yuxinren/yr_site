...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm('service_y77xfqx', 'template_q87omvy', form.current, 'VK_uBLG66jKMp5LgZ')
      .then(
        () => {
    ...
    <>
      <div className="container contact-page">
        <div className="text-zone">
          ...
          <p>
            I am interested in freelance opportunities - especially on software engineering related jobs.
